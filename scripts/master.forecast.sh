...
# can't use -u optioni33_remove_workround
set +u
conda activate osop
set -u
...
area="40,10,10,40" # sub-area in degrees for area of interest (comma separated N,W,S,E) #"45,-30,-2.5,60"  If running pycpt this is the predictand.
