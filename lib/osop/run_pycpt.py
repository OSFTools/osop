...
def process_pycpt(predict_config, pycptdir, hindcast_pycptdir,):
    ...
    calibrate(Hcast_fname, Fcast_fname, Ocast_fname, output_case_dir, predictor_extent, predictor_names, predictand_name)
    return

def calibrate(Hfname, Ffname, Ofname, case_dir, predictor_extent, predictor_name, predictand_name):
