...
that feel they have contributed to an extension of its capabilities to
engage with GitHub's pull request systems and pass the improvements back
into the programme.
 
The documentation includes a user guide and API reference.
